...
public class CheatActivity extends AppCompatActivity {
    ...
    private static final String EXTRA_ANSWER_IS_TRUE = "com.thenerdbiker.android.geoquiz.answer_is_true";
    private static final String EXTRA_ANSWER_SHOWN = "com.thenerdbiker.android.geoquiz.answer_shown";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBuildTextView.setText(String.format("API Level %d", Build.VERSION.SDK_INT));
